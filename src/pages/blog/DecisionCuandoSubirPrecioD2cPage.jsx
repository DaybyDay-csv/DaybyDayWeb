...
const DecisionCuandoSubirPrecioD2cPage = ({ openCalendly }) => (
  <BlogPostLayout
    ...
    faqs={faqs}
    relatedPosts={relatedPostsData["decision-cuando-subir-precio-d2c"] || []}
