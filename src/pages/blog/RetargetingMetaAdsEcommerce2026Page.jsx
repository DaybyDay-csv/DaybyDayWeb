  ...
  >
    ...
    <div className="space-y-3">
      <div className="bg-[#1a1616] border border-white/8 rounded-xl p-4">
        ...
        <p className="text-white/40 text-xs mt-1">Cómo encaja el retargeting Meta dentro del bucket retención y qué % del presupuesto le corresponde por madurez de marca</p>
      </div>
      <div className="bg-[#1a1616] border border-white/8 rounded-xl p-4">
