...
const CboVsAboMetaAds2026CualGanaEnEcommerceEspanaPage = ({ openCalendly }) => (
  ...
  >
    ...
    <p className="text-white/70 leading-relaxed mb-5">
      Fuentes consultadas: <a href="https://www.statista.com/statistics/1347511/meta-advertising-cbo-effectiveness/" target="_blank" rel="nofollow noopener" className="underline text-white/80">Statista (2025)</a>, <a href="https://developers.facebook.com/docs/marketing-api/conversions-api" target="_blank" rel="nofollow noopener" className="underline text-white/80">Meta for Business (2025)</a>, análisis interno DayByDay con datos de cuentas activas.
    </p>
