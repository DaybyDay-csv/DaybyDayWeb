...
const faqs = [
  ...
  },
  {
    ...
    a: "Conviene aplicar MMM cuando se cumplen las tres condiciones a la vez: spend total \u003e50K€/mes, 4+ canales en paralelo (Meta, Google, TikTok, email, afiliación u offlin\u003e) y >12 meses de histórico semanal granular. Por debajo de eso, MMM es teatro estadístico: el modelo no tiene varianza suficiente para separar señal de ruido. En cuentas pequeñas (<30K€/mes, 1-2 canales), data-driven en GA4 + análisis incremental por canal es suficiente. MMM también es overkill cuando el journey es muy corto (ticket impulsivo único) o cuando el negocio no puede mover sus presupuestos lo suficiente como para generar la variabilidad que el modelo necesita."
  },
  {
  ...
  >
    ...
    <div className="space-y-3">
      ...
      <div className="bg-[#1a1616] border border-white/8 rounded-xl p-4">
        ...
        <p className="text-white/40 text-xs mt-1">Por qué el modelado complementario tipo MMM se hace más necesario con iOS 17/18</p>
      </div>
      <div className="bg-[#1a1616] border border-white/8 rounded-xl p-4">
