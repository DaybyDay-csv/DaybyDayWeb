...
const Ga4MetaServerSideTrackingShopifySinDoloresDeCabezaPage = ({ openCalendly }) => (
  ...
  >
    ...
    <p className="text-white/70 leading-relaxed mb-5">
      Fuentes consultadas: <a href="https://www.facebook.com/business/news/building-the-future-of-conversion-apis" target="_blank" rel="nofollow noopener" className="underline text-white/80">Meta for Business (2024)</a>, <a href="https://ads.google.com/privacy/gclid" target="_blank" rel="nofollow noopener" className="underline text-white/80">Google Ads (2024)</a>, <a href="https://www.shopify.com/es/enterprise/analytics" target="_blank" rel="nofollow noopener" className="underline text-white/80">Shopify (2025)</a>.
    </p>
